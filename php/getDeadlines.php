...
if(isset($_POST["day"]) && isset($_POST['month']) && isset($_POST['year'])) {
    ...
    $sql = "SELECT deadlines.id, deadlines.author_id, deadlines.date, deadlines.max_student_count, deadlines.created_at, users.first_name, users.last_name FROM deadlines, users WHERE deadlines.date BETWEEN ? AND ? AND users.id = deadlines.author_id";
